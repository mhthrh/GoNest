...
const (
	...
	CustomerService_GetCustomerByName_FullMethodName = "/customer.CustomerService/GetCustomerByName"
)
...
type CustomerServiceClient interface {
	RegisterCustomer(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
	GetCustomerById(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Response, error)
	GetCustomerByName(ctx context.Context, in *Name, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *customerServiceClient) RegisterCustomer(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (c *customerServiceClient) GetCustomerById(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
...
func (c *customerServiceClient) GetCustomerByName(ctx context.Context, in *Name, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, CustomerService_GetCustomerByName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServiceServer interface {
	RegisterCustomer(context.Context, *Request) (*Response, error)
	GetCustomerById(context.Context, *Id) (*Response, error)
	GetCustomerByName(context.Context, *Name) (*Response, error)
...
func (UnimplementedCustomerServiceServer) RegisterCustomer(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterCustomer not implemented")
}
func (UnimplementedCustomerServiceServer) GetCustomerById(context.Context, *Id) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCustomerById not implemented")
}
func (UnimplementedCustomerServiceServer) GetCustomerByName(context.Context, *Name) (*Response, error) {
...
func _CustomerService_RegisterCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).RegisterCustomer(ctx, req.(*Request))
	}
...
func _CustomerService_GetCustomerByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerService_GetCustomerByName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetCustomerByName(ctx, req.(*Name))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CustomerService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "model/customer/grpc/customer/sCustomer.proto",
}
